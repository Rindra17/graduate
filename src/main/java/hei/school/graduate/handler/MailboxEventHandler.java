package hei.school.graduate.handler;

import static hei.school.graduate.concurrency.ThreadRenamer.renameWorkerThread;
...
import hei.school.graduate.PojaApplication;
import hei.school.graduate.PojaGenerated;
import hei.school.graduate.endpoint.EndpointConf;
import hei.school.graduate.endpoint.event.EventConf;
import hei.school.graduate.endpoint.event.consumer.EventConsumer;
import hei.school.graduate.endpoint.event.consumer.model.ConsumableEvent;
import hei.school.graduate.endpoint.event.consumer.model.ConsumableEventTyper;
