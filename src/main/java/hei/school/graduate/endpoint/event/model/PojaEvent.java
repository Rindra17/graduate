package hei.school.graduate.endpoint.event.model;

import static hei.school.graduate.endpoint.event.EventStack.EVENT_STACK_1;
import static java.lang.Math.random;

import hei.school.graduate.PojaGenerated;
import hei.school.graduate.endpoint.event.EventStack;
...
public abstract class PojaEvent implements Serializable {
  ...
  public String getEventSource() {
    if (getEventStack().equals(EVENT_STACK_1)) return "hei.school.graduate.event1";
    return "hei.school.graduate.event2";
  }
}
