package hei.school.graduate.endpoint.event.consumer;

import hei.school.graduate.PojaGenerated;
import hei.school.graduate.endpoint.event.consumer.model.TypedEvent;
...
public class EventServiceInvoker implements Consumer<TypedEvent> {
  ...
  public void accept(TypedEvent typedEvent) {
    ...
    var eventClasses = getAllClasses("hei.school.graduate.endpoint.event.model");
  ...
  private String getEventService(String eventClazzName) {
    ...
    return "hei.school.graduate.service.event."
