...
public class CourseController {
    ...
    @PutMapping("/id")
    public Course updateCourseById(@RequestParam UUID id, CourseRequest newCourse) {
    ...
    public void addTeacherToCourse(@RequestParam UUID id, @RequestBody CourseTeacherRequest courseTeacherRequest) {
